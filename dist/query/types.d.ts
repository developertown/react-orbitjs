...
export interface IQueryOptions<THocProps = any> {
    ...
    noTimeout?: boolean;
    timeout?: number;
    mapResultsFn?: <TMapResult>(props: any, result: any, hocProps: THocProps | object) => Promise<TMapResult>;
    hocProps?: THocProps;
}
export declare type IProvidedProps<TResult extends object> = IState<TResult> & {
    refetch: () => void;
};
